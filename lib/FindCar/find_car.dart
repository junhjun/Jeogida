    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        appBar: AppBar( // 상단바
            ...
            title: Text('내 차 찾기', style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.w500))
        ),
        body: Container(
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('B1층 A구역 30번', style: TextStyle(color: Colors.cyan, fontSize: 20, fontWeight: FontWeight.w700)),
                    Column(
                      children: [
                        Text('위치 : 개봉 현대아파트', style: TextStyle(color: Colors.grey, fontSize: 13)),
                        Text('주차시간 : 3시간 30분', style: TextStyle(color: Colors.grey, fontSize: 13))
                      ],
                    )
                  ]
                ),
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.circle, size: 7, color: Colors.deepOrangeAccent),
                          Text('현재 위치', style: TextStyle(color: Colors.grey, fontSize: 12))
                        ],
                      ),
                    ),
                    Container(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.rectangle, size: 12, color: Colors.deepOrangeAccent),
                          Text('주차 위치', style: TextStyle(color: Colors.grey, fontSize: 12))
                        ],
                      ),
                    )
                  ],
