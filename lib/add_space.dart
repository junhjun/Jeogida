...
class AddSpace extends StatefulWidget { // StatefulWidget 사용
  @override
  _MyState createState() => _MyState();
}
class _MyState extends State<AddSpace>
{
    ...
    return MaterialApp(
        ...
        home: Scaffold(
          appBar: AppBar( // 상단바
              ...
              title: Text('주차장 추가', style: TextStyle(color: Colors.black, fontSize: 20, fontWeight: FontWeight.w500))
          ),
          ...
          body: Container(
            ...
            child: Column(
              ...
              children: [
                Text('주차장 선택', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w500)),
                Center(
                  child: Container( // 너비 조절을 위해 컨테이너로 감쌈
                ...
                Container(
                  ...
                  child: ElevatedButton(onPressed: (){},
                      child: Text('주차장 추가', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600)),
