                    ...
                    Container(
                      ...
                      child: CheckboxListTile(
                        ...
                        onChanged: (bool? value) {
                          ...
                          setState(() {
                            allchecked1 = value!;
                            ischecked_list1.fillRange(0, ischecked_list1.length,
                                value); // 체크 리스트의 모든 원소를 한 번에 변경
                          });
                        },
                      ...
                      onChanged: (bool? value) {
                        setState(() {
                          ...
                          ischecked_list2.fillRange(
                              0, ischecked_list2.length, value);
                        });
                      },
                      checkboxShape: CircleBorder(),
                    ),
  ...
  Widget build(BuildContext context) {
    if (widget.data_car.isNotEmpty) {
      return ListView.builder(
        // 차량 리스트
        physics:
            NeverScrollableScrollPhysics(), // 이거 없으면 ListTile을 터치하여 스크롤 하는 것이 안 됨
        shrinkWrap: true,
        ...
        itemBuilder: (context, i) {
          ...
          return Container(
            ...
            child: CheckboxListTile(
              title: Text(widget.data_car[i]["name"],
                  style: TextStyle(fontSize: 17, fontWeight: FontWeight.w500)),
              subtitle: Text(widget.data_car[i]["number"],
